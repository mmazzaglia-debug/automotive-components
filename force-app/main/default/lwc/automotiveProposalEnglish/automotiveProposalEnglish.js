...
import { OMNIDEF } from './automotiveProposalEnglish_def.js';
import tmpl from './automotiveProposalEnglish.html';
import tmpl_nds from './automotiveProposalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class automotiveProposalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
