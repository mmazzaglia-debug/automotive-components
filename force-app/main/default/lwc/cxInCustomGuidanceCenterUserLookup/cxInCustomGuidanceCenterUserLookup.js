...
import retriveSearchData from '@salesforce/apex/cxInCustomGuidanceCenterUserLookupCls.retriveSearchData';
export default class CxInCustomGuidanceCenterUserLookup extends LightningElement {
    @api objectname = 'User';
