...
import { OMNIDEF } from './docGenComponentEnglish_def.js';
import tmpl from './docGenComponentEnglish.html';
import tmpl_nds from './docGenComponentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenComponentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
